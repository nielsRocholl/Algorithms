...
from data import naive_bayes_data
...
article = ['article', 'writes', 'while', 'when', 'owned', 'Plus', 'wanted', 'upgrade', 'memory', 'just', 'ordered',
           'toolkit', 'from', 'Macwarehouse', 'something', 'like', 'included', 'antistatic']

MNB = MultinomialNB(naive_bayes_data)
print(MNB.predict(article))
